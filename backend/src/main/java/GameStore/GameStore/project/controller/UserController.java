...
import GameStore.GameStore.project.service.UserService;
...
public class UserController {
    ...
    public ResponseEntity<List<Game>> allGames() {
        ...
        User currentUser = (User) authentication.getPrincipal();
        // System.out.println("This is the id of the cur user " + currentUser.getId());
        List<Game> games = userService.allGames(currentUser.getId());
